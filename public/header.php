              ...
              <div class=" d-flex justify-content-end order-lg-3" style="width: 100%;">
                <ul class="navbar-nav ms-auto text-dark">
                  ...
                  if(isset($_SESSION['user']) && !empty($_SESSION['user'])){
                    echo '<a class="head-text btn btn-dark d-sm-inline-block d-none ms-3" href="user/profile.php">Profile</a>';
                      
                  }else{
                    echo '<a class="head-text btn btn-dark d-sm-inline-block d-none ms-3" data-bs-toggle="modal" data-bs-target="#staticBackdrop" href="/login.php">Login</a>';
                  }
                ?>
                </nav>
